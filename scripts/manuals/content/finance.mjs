          ...
          blocks: [
            {
              ...
              items: [
                {
                  label: ["Authority one", "Mamlaka ya kwanza"],
                ...
                {
                  label: ["Authority two", "Mamlaka ya pili"],
      ...
      pages: [
        {
          ...
          eyebrow: ["Navigation", "Menyu"],
          blocks: [
            {
              type: "table",
              head: [["Menu", "Menyu"], ["What it is, and when to use it", "Ni nini, na itumike lini"]],
              rows: [
      ...
      pages: [
        {
          ...
          eyebrow: ["Nothing settles without you", "Hakuna kinachokamilika bila wewe"],
        ...
        },
        {
          ...
          eyebrow: ["Cargo moves when you say so", "Mzigo unatoka pale unaposema"],
        ...
        },
        {
          ...
          eyebrow: ["Oldest first", "Kongwe kwanza"],
        ...
        },
        {
          ...
          eyebrow: ["Where the money sits", "Pesa zilipo"],
        ...
        },
        {
          ...
          eyebrow: ["The rate book, and the record", "Kitabu cha bei, na kumbukumbu"],
          ...
          blocks: [
            {
              type: "flow",
              steps: [
                { who: ["Guangzhou", "Guangzhou"], what: ["Cargo registered and labelled", "Mzigo unasajiliwa na kuwekewa lebo"], tone: "draft" },
                { who: ["Guangzhou", "Guangzhou"], what: ["Sealed and flown", "Kundi linafungwa na kusafirishwa"], tone: "draft" },
                { who: ["Dar floor", "Ghala la Dar"], what: ["Checked in against the manifest", "Unakaguliwa kwa orodha ya mizigo"], tone: "owed" },
                { who: ["System", "Mfumo"], what: ["Priced automatically as a DRAFT", "Unapangiwa bei kiotomatiki kama RASIMU"], tone: "owed",
                  note: ["A draft owes nobody anything.", "Rasimu haimdai mtu chochote."] },
                { who: ["You", "Wewe"], what: ["Confirm the price", "Thibitisha bei"], tone: "info",
                ...
                { who: ["Customer Care", "Huduma kwa Wateja"], what: ["Ring the customer", "Mpigie mteja simu"], tone: "info" },
                { who: ["Customer", "Mteja"], what: ["Pays", "Analipa"], tone: "info" },
                { who: ["Customer Care", "Huduma kwa Wateja"], what: ["Submit the claim with proof", "Wasilisha dai pamoja na ushahidi"], tone: "info",
                  note: ["A claim is not money.", "Dai siyo pesa."] },
                { who: ["You", "Wewe"], what: ["Verify the payment", "Thibitisha malipo"], tone: "paid",
                  note: ["Receipt numbered, ledger posted.", "Risiti inapewa namba, daftari linaandikwa."] },
                { who: ["You", "Wewe"], what: ["Issue the pickup note", "Toa hati ya kuchukua"], tone: "paid" },
      ...
      pages: [
        {
          ...
          eyebrow: ["Follow the money", "Fuatilia pesa"],
          blocks: [
            {
              type: "example",
              fields: [
                { k: ["Customer", "Mteja"], v: "John Peter" },
                { k: ["Tracking", "Namba ya ufuatiliaji"], v: "TX-000042" },
                { k: ["Weight", "Uzito"], v: "3.6 kg" },
                { k: ["Freight", "Nauli"], v: "USD 48.60" },
              ],
            },
            {
              type: "table",
          ...
          blocks: [
            {
              ...
              columns: 2,
              items: [
                { label: ["Drafts", "Rasimu"], title: ["Confirm the day it lands", "Thibitisha siku inapofika"], body: ["Confirming recalculates storage. A bill confirmed three weeks late charges three weeks of storage.", "Kuthibitisha kunahesabu upya uhifadhi. Ankara iliyothibitishwa wiki tatu baadaye inatoza uhifadhi wa wiki tatu."] },
                { label: ["Proof", "Ushahidi"], title: ["Open every attachment", "Fungua kila kiambatisho"], body: ["The account matters more than the amount.", "Akaunti ni muhimu zaidi kuliko kiasi."] },
                { label: ["Notes", "Hati"], title: ["Issue the moment it settles", "Toa mara tu inapolipwa"], body: ["The customer may already be on their way to the counter.", "Mteja anaweza kuwa tayari yuko njiani kuelekea kaunta."] },
                { label: ["Accounts", "Akaunti"], title: ["Always name where it landed", "Daima taja pesa ilipoingia"], body: ["Every figure on Accounts is derived from these entries.", "Kila takwimu kwenye Akaunti inatokana na maandishi haya."] },
                { label: ["Chasing", "Kufuatilia"], title: ["Oldest first, always", "Kongwe kwanza, daima"], body: ["The oldest debt is the least likely to be collected.", "Deni kongwe ndilo lenye nafasi ndogo ya kukusanywa."] },
                { label: ["Refusals", "Kukataliwa"], title: ["A refusal is a warning", "Kukataliwa ni onyo"], body: ["If the system stops you, the numbers disagree. Do not look for a way around it.", "Mfumo ukikuzuia, takwimu hazikubaliani. Usitafute njia ya kuzunguka."] },
              ],
            },
          ],
        },
