  ...
  return (
    <>
      <PageHeader
        ...
        description="Customers who want something found, priced or bought in China."
      />
      ...
      {requests.some((r) => r.status === "CANCELLED") ? (
        <p className="mt-4 text-sm text-muted-foreground">
          {requests.filter((r) => r.status === "CANCELLED").length} cancelled
          request(s) are kept out of the board but remain on each customer&rsquo;s
          profile.
        </p>
      ) : null}
    </>
